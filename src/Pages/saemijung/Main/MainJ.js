            ...
            <nav className="top">
                <div className="nav">
                    <div className="logo_box">
                        ...
                        <span className="instagram_logo">instagram</span>
                    </div>
                    ...
                    <div className="right_box">
                        ...
                        <img className="icons" src="./img/explore.png" alt="나침반"/>
                        <img className="icons" src="./img/heart.png" alt="하트"/>
                        <img className="icons" src="./img/profile.png" alt="프로필 이미지"/>
                    </div>
                </div>
            </nav>
